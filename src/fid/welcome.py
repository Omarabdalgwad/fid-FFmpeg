...
def welcome():
    ...
    console.print(Text(ascii, style="bold magenta"))
    video_panel = Panel(
        "- Compress video\n"
        "- Create GIF\n",title="Video Options",border_style="cyan",box=box.ROUNDED,)
    audio_panel = Panel(
        "- Extract audio\n"
        "- Normalize audio\n"
        "- Noise reduction",
    ...
    capcut_panel = Panel(
        ...
        " Noise reduction\n",title="CapCut Pro",border_style="magenta",box=box.ROUNDED,)
    ...
    interactive = Panel(left_grid,title="Interactive Options",border_style="bright_cyan",box=box.DOUBLE,padding=(1, 2),)
